...
create table public.products (
    ...
    -- Stores the raw price (e.g., 2150000)
...
create policy "Deals are viewable by everyone" on public.deals for
select using (true);
...
values (
    ...
    (
        ...
        550000,
        450000,
        'https://m.media-amazon.com/images/I/41D5CgWzC4L._AC_SY879_.jpg',
        'Audio',
        true
    ),
    (
